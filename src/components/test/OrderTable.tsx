...
import { AddToCartButton, Modal, ModalContent, CloseButton, Input, SubmitButton, ErrorMessage } from '../styles/style';
...
export default function OrderTable() {
  ...
  const [todos, setTodos] = useState<any[]>(() => {const storedTodos = localStorage.getItem('todos'); return storedTodos ? JSON.parse(storedTodos) : [];});
                  ...
                  <Box sx={{ display: 'flex', gap: 2, alignItems: 'center' }}>
                    <Dropdown>
                      ...
                      <Menu size="sm" sx={{ minWidth: 100 }}>
                        ...
                        <Divider />
                        <MenuItem color="danger" onClick={() => handleDelete(todo._id)}>Delete</MenuItem>
                      </Menu>
                    </Dropdown>
                  </Box>
                </td>
